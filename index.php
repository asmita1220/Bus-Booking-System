    ...
    <div id="content">
    	<div id="rotator">
              <ul>
                    ...
                    <li><img src="xres/images/jb2/19.jpg" width="861" height="379"  alt="" /></li>
			  ...
			  <div id="logo" style="left: 600px; height: auto; top: 23px; width: 260px; position: absolute; z-index:4;">
					...
					<h2 class="accordion-header" style="height: 18px; margin-bottom: 15px; color: rgb(255, 255, 255); background: none repeat scroll 0px 0px rgb(53, 48, 48);">Ticket cancel</h2>
					<div class="accordion-content" style="margin-bottom: 15px;">
						<form action="Cancel.php" method="post" style="margin-bottom:none;">
						<input type="submit" id="submit" class="medium gray button" value="cancel" style="height: 34px; margin-left: 15px; width: 191px; padding: 5px; border: 3px double rgb(204, 204, 204);" />
						</form>
						</div>
